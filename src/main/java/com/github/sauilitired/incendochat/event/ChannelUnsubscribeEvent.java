...
/**
 * Event sent when a {@link ChatPlayer} unsubscribes from a
 * {@link ChatChannel}
 */
public class ChannelUnsubscribeEvent extends PlayerChannelEvent {

    private static final HandlerList handlers = new HandlerList();

    public ChannelUnsubscribeEvent(@NotNull
    final ChatChannel chatChannel, @NotNull final ChatPlayer player) {
